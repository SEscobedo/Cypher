...
-   **Application** means the software program provided by the Company
    downloaded by You on any electronic device, named CypherX

-   **Company** (referred to as either "the Company", "We", "Us" or
    "Our" in this Agreement) refers to CypherX.
...
-   By visiting this page on our website:
    [https://github.com/SEscobedo/CypherX](https://github.com/SEscobedo/CypherX)
